...
type Region = (String,String) -- (Country,Region)

region1 = ("France","Bordeux") :: Region
...
wine1 = Red 14.5 :: Kind
wine2 = White 13.0 :: Kind
wine3 = Rose 12.0 :: Kind
...
data Label = Label {grape :: [Grape], region :: Region, kind :: Kind} deriving (Show)

-- Larrosa Rose is a rose wine from the region Rioja. It is made from the Garnacha grape and 
-- has a alcohol level of 14%.

larrosaRose = Label ["Garnacha"] ("Spain","Rioja") (Rose 14.0) 
...
castiglioni = Label [grape1]  ("Italy","Tuscany") (Red 12.5)
...
lePetitHaitLafitte = Label ["Cabernet-sauvignon","Merlot"] region1 (Red 13.5)
...
labelList = [larrosaRose,castiglioni,lePetitHaitLafitte]

containsGrape :: [Label] -> Grape -> Bool 
containsGrape labels g = elem g $ concat $ (map (grape) labels)
